...
//
// Thanks to my boss, Jean Côt? who joyfully granted me the 2 days necessary for this mission.
//
...
public:
	...
	void UpdateTipText(CWnd *pWnd,CString strTxt);
