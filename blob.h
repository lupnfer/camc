...
public:
	...
	std::vector<CvPoint>& FindDominantPoints(double p1=15,double p2=20,double p3=20,double p4=150);
	void DrawDominantPoints(IplImage* img,CvScalar color);
	...
	void DrawBlobContour(IplImage* image,CvScalar color,int offsetX = 0, int offsetY = 0);
	...
	CvBox2D GetMinBoundingRect();
	std::vector<CvPoint>& GetDominantPoints(){return m_dpList;}
private:
