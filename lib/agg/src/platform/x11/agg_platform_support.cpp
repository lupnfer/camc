...
namespace agg
{
    ...
    bool platform_support::init(unsigned width, unsigned height, unsigned flags)
    {
        ...
        m_specific->m_screen = DefaultScreen(m_specific->m_display);
        m_specific->m_depth  = DefaultDepth(m_specific->m_display, 
                                            m_specific->m_screen);
        m_specific->m_visual = DefaultVisual(m_specific->m_display, 
                                             m_specific->m_screen);
...
//         }
        ...
        m_specific->m_window_attributes.border_pixel = 
            BlackPixel(m_specific->m_display, m_specific->m_screen);

        m_specific->m_window_attributes.background_pixel = 
            WhitePixel(m_specific->m_display, m_specific->m_screen);
        ...
        m_specific->m_window = 
            XCreateWindow(m_specific->m_display, 
                          DefaultRootWindow(m_specific->m_display), 
                          0, 0,
                          width,
                          height,
                          0, 
