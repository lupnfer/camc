    ...
    public:
        ...
        void square(int x, int y, int r)
        {
            ...
            {  
                ...
                else  ren().blend_pixel(x, y, fill_color(), cover_full);
            }
        }
        ...
        void diamond(int x, int y, int r)
        {
            if(visible(x, y, r))
            {
                if(r)
                {
                    ...
                    do
                    {
                        ren().blend_pixel(x - dx, y + dy, line_color(), cover_full);
                        ren().blend_pixel(x + dx, y + dy, line_color(), cover_full);
                        ren().blend_pixel(x - dx, y - dy, line_color(), cover_full);
                        ren().blend_pixel(x + dx, y - dy, line_color(), cover_full);
                        ...
                        if(dx)
                        {
                            ren().blend_hline(x-dx+1, y+dy, x+dx-1, fill_color(), cover_full);
                            ren().blend_hline(x-dx+1, y-dy, x+dx-1, fill_color(), cover_full);
                        }
                        ++dy;
                        ++dx;
                ...
                {
                    ren().blend_pixel(x, y, fill_color(), cover_full);
                }
            }
        }
        ...
        void crossed_circle(int x, int y, int r)
        {
            if(visible(x, y, r))
            {
                if(r)
                {
                    ...
                    if(r <= 2) r6++;
                    r >>= 1;
                    ren().blend_hline(x-r6, y, x-r,  line_color(), cover_full);
                    ren().blend_hline(x+r,  y, x+r6, line_color(), cover_full);
                    ren().blend_vline(x, y-r6, y-r,  line_color(), cover_full);
                    ren().blend_vline(x, y+r,  y+r6, line_color(), cover_full);
                }
                else
                {
                    ren().blend_pixel(x, y, fill_color(), cover_full);
            ...
            if(visible(x, y, r))
            {
                if(r)
                {
                    ...
                    do
                    {
                        ...
                        ren().blend_pixel(x + dy, y + dx, line_color(), cover_full);
                        ren().blend_pixel(x + dy, y - dx, line_color(), cover_full);
                        
                        if(ei.dy() && dx)
                        {
                            ren().blend_vline(x+dy, y-dx+1, y+dx-1, fill_color(), cover_full);
                        }
                        ++ei;
                    }
                    while(dy < r8);
                    ren().blend_vline(x+dy, y-dx, y+dx, line_color(), cover_full);
                }
                else
                {
                    ren().blend_pixel(x, y, fill_color(), cover_full);
        ...
        void semiellipse_up(int x, int y, int r)
        {
            if(visible(x, y, r))
            {
                if(r)
                {
                    ...
                    while(dy < r8);
                    ren().blend_hline(x-dx, y-dy-1, x+dx, line_color(), cover_full);
                }
                else
                {
                    ren().blend_pixel(x, y, fill_color(), cover_full);
        ...
        void triangle_up(int x, int y, int r)
        {
            if(visible(x, y, r))
            {
                if(r)
                {
                    ...
                    while(dy < r6);
                    ren().blend_hline(x-dx, y-dy, x+dx, line_color(), cover_full);
                }
                else
                {
                    ren().blend_pixel(x, y, fill_color(), cover_full);
        ...
        void cross(int x, int y, int r)
        {
            if(visible(x, y, r))
            {
                if(r)
                {
                    ren().blend_vline(x, y-r, y+r, line_color(), cover_full);
                    ren().blend_hline(x-r, y, x+r, line_color(), cover_full);
                }
                else
                {
                    ren().blend_pixel(x, y, fill_color(), cover_full);
        ...
        void xing(int x, int y, int r)
        {
            if(visible(x, y, r))
            {
                if(r)
                {
                    ...
                    do
                    {
                        ren().blend_pixel(x + dy, y + dy, line_color(), cover_full);
                        ren().blend_pixel(x - dy, y + dy, line_color(), cover_full);
                        ren().blend_pixel(x + dy, y - dy, line_color(), cover_full);
                        ren().blend_pixel(x - dy, y - dy, line_color(), cover_full);
                        ++dy;
        ...
        void dash(int x, int y, int r)
        {
            if(visible(x, y, r)) 
            {
                if(r) ren().blend_hline(x-r, y, x+r, line_color(), cover_full);
                else  ren().blend_pixel(x, y, fill_color(), cover_full);
            }
        }
        ...
        void markers(int n, const T* x, const T* y, T r, marker_e type)
        {
            ...
            if(r == 0)
            {
                do
                {
                    ren().blend_pixel(int(*x), int(*y), fill_color(), cover_full);
                    ++x;
                    ++y;
                }
                while(--n);
